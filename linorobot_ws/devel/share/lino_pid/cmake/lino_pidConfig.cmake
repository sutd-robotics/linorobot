...
if("TRUE" STREQUAL "TRUE")
  set(lino_pid_SOURCE_PREFIX /home/soar/linorobot_ws/src/lino_pid)
  set(lino_pid_DEVEL_PREFIX /home/soar/linorobot_ws/devel)
  set(lino_pid_INSTALL_PREFIX "")
  set(lino_pid_PREFIX ${lino_pid_DEVEL_PREFIX})
else()
  set(lino_pid_SOURCE_PREFIX "")
  set(lino_pid_DEVEL_PREFIX "")
  set(lino_pid_INSTALL_PREFIX /home/soar/linorobot_ws/install)
...
if(NOT "/home/soar/linorobot_ws/devel/include;/home/soar/linorobot_ws/src/lino_pid/include " STREQUAL " ")
  set(lino_pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/soar/linorobot_ws/devel/include;/home/soar/linorobot_ws/src/lino_pid/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lino_pid' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Juan Jimeno <jimenojmm@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lino_pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soar/linorobot_ws/src/lino_pid/${idir}'.  Ask the maintainer 'Juan Jimeno <jimenojmm@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/soar/linorobot_ws/devel/lib;/home/soar/linorobot_ws/devel/lib;/opt/ros/kinetic/lib)
