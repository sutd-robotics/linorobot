#! /usr/bin/env python
# Authors: Jun Yu (foundation), Paul & Abhimanyu (debugging), methylDragon (debugging, P implementation, algorithm tweaks)
...
class Follower:
    ...
    def __init__(self):
        self.scan_sub = rospy.Subscriber('scan', LaserScan, self.scan_callback) # Subscriber
        self.cmd_vel_pub = rospy.Publisher('cmd_vel', Twist, queue_size=1) # Publisher
        self.twist = Twist()
